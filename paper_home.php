						...
						if($p6){
							?>
								<ul class="list-group">
									...
									?><div class="mt-2"></div>
									<li style="text-align: right"><a class="btn btn-primary" href="<?php echo strtolower(get_file('papers/p6')) ?>">VIEW MORE</a></li>
								</ul>
							<?php
						}else{
						...
						if($p6){
							?>
								<ul class="list-group">
									...
									?>
									<div class="mt-2"></div>
									<li style="text-align: right"><a class="btn btn-primary" href="<?php echo get_file('papers/s3'); ?>">VIEW MORE</a></li>
								</ul>
							<?php
						}else{
							echo "No S3 papers";
