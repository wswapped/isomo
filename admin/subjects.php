						...
						<div id="content">
							 <div class="panel box-shadow-none content-header">
									<div class="panel-body">
										<div class="col-md-12">
												<h3 class="animated fadeInLeft">Subjects</h3>
												<p class="animated fadeInDown">
													Home <span class="fa-angle-right fa"></span> subject
												</p>
										</div>
									</div>
							</div>
							<div class="col-md-12 top-20 padding-0">
								<div class="col-md-12">
									<div class="panel">
										<div class="panel-heading"><h3>Our subjects</h3></div>
										<div class="panel-body">
											<div class="responsive-table">
											<?php
												$query = $db->query("SELECT S.*, T.name as typename FROM subjects as S JOIN subject_type AS T ON S.type = T.id ");
											?>
