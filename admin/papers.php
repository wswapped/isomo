            ...
            <div id="content">
              ...
              <div class="col-md-12 top-20 padding-0">
                <div class="col-md-12">
                  ...
                  <button class="btn btn-primary btn-fab" data-toggle="modal" data-target="#createPaper"><span class="fa fa-2x fa-plus"></span></button>
                </div>
              </div>  
              </div>
            </div>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="admin.php" method="POST" enctype="multipart/form-data" id="addPaper">
                    ...
                    <div class="form-group" data-for='national_exams'>
                    ...
                    <div class="form-group" data-for='national_exams,driving_exam,traffic_rules'>
