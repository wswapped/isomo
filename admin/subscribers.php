						...
						<div id="content">
							 <div class="panel box-shadow-none content-header">
									<div class="panel-body">
										<div class="col-md-12">
												<h3 class="animated fadeInLeft">Subscribers</h3>
												<p class="animated fadeInDown">
													Home <span class="fa-angle-right fa"></span> Subscribers
												</p>
										</div>
									</div>
							</div>
							<div class="col-md-12 top-20 padding-0">
								<div class="col-md-12">
									<div class="panel">
										<div class="panel-heading"><h3>Our communication subscribers</h3></div>
										<div class="panel-body">
											<div class="responsive-table">
											<?php
												$query = $db->query("SELECT * FROM subscribers WHERE stopDate = '' OR stopDate IS NULL ");
											?>
