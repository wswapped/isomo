						...
						<div class="col-md-8 padding-0">
							<div class="col-md-12 padding-0">                                
									...
									<div class="panel box-v1">
									  <div class="panel-heading bg-white border-none">
										<div class="col-md-6 col-sm-6 col-xs-6 text-left padding-0">
										  <h4 class="text-left">Papers</h4>
										</div>
										<div class="col-md-6 col-sm-6 col-xs-6 text-right">
										   <h4>
										   <span class="icon-docs icons icon text-right"></span>
										   </h4>
										</div>
									  </div>
									  <div class="panel-body text-center">
										<h1><a href='papers'><?php  echo n_total_papers(); ?></a></h1>
										<!-- <p>New Orders</p> -->
										<hr/>
									  </div>
									</div>
								...
								<div class="col-md-6">
									<div class="panel box-v1">
									  ...
									  <div class="panel-body text-center">
										<h1><a href='users'><?php  echo n_total_users(); ?></a></h1>
										<!-- <p>User active</p> -->
										<hr/>
									  </div>
									</div>
							...
							<div class="col-md-12">
								<div class="panel box-v4">
									<div class="panel-heading bg-white border-none">
									  <h4><span class="icon-notebook icons"></span> Contacts</h4>
									</div>
									<div class="panel-body padding-2">
										<!-- <h2>People who contacted via the contact us</h2> -->
										<?php
										  ...
										  foreach ($contacts as $key => $message) {
										  	...
										  	?>
										  		<div>
										  			<h3><?php echo $name; ?></h3>
										  			<p><?php echo $email; ?></p>
										  			<p style="background: #eee;padding: 12px"><?php echo $message; ?></p>
										  		</div>
										  	<?php
										  }
